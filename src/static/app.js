document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear and populate activity select (keep placeholder)
  ...
  signupForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        signupForm.reset();
        // Refresh activities list to show new participant without full page reload
        fetchActivities();
      } else {
...
// Helper to show messages from other handlers
